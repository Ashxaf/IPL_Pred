...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://mir-s3-cdn-cf.behance.net/project_modules/fs/05834e80113099.6210bd8ad5bf7.jpg");
...
st.markdown(
    """
    <style>
    /* Change the text color of the select box options */
    select_option {
...
select_option=batting_team= st.selectbox('Select batting team ',('Chennai Super Kings', 'Delhi Daredevils', 'Kings XI Punjab','Kolkata Knight Riders','Mumbai Indians','Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad'))
